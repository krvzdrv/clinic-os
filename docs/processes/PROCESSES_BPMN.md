...
| `docs/bpmn/encounter-reason-mature.bpmn` | Развилка **перед** открытием приёма: есть активные диагнозы → повод «продолжение» (одно/несколько) или «новая жалоба»; связь `encounter_reason` пишется сразу при открытии, а не додумывается по факту диагноза внутри приёма. Доктор-версия и разбор по коду: `docs/explain/07-encounter-types.md` |
